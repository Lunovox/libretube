	...
	if(count($Video)==1){
		...
		<center>
			<div class="FormSession" align="justify">
 				<center>
 					<video id="VideoPlayer" controls autoplay align="center" poster="<?php echo $Video[0]['urlPoster']; ?>" oncontextmenu_="return false;">
				...
				<center>
					...
					<button 
						...
						onclick="document.getElementById('boxComentario').style.display = 'inline';"
					>
						<img 
